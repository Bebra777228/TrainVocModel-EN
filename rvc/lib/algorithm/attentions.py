...
from rvc.lib.algorithm.commons import subsequent_mask
from rvc.lib.algorithm.modules import LayerNorm
...
class Encoder(nn.Module):
    ...
    def forward(self, x, x_mask):
        ...
        x = x * x_mask
        zippep = zip(self.attn_layers, self.norm_layers_1, self.ffn_layers, self.norm_layers_2)

...
from infer.lib.infer_pack import refinegan_fix_launch_simplcup_pretrain
from infer.lib.infer_pack.refinegan_fix_launch_simplcup_pretrain import RefineGANGenerator
